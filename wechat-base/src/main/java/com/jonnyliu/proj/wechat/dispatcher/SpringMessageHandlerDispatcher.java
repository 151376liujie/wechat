 ...
 * @date 2016-09-06 20:59.
 */
@Component
public class SpringMessageHandlerDispatcher implements MessageHandlerDispatcher, ApplicationContextAware {

    private static final Logger LOGGER = LoggerFactory.getLogger(SpringMessageHandlerDispatcher.class);

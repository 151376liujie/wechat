...
import com.jonnyliu.proj.wechat.pojo.message.request.CustomMenuClickOrViewEventRequestMessage;
...
//            }
            return MessageUtils.buildTextResponseMessage(baseRequestMessage,customMenuClickOrViewEventRequestMessage.getEvent());
        }

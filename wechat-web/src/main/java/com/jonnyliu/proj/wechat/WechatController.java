...
import com.jonnyliu.proj.wechat.dispatcher.MessageHandlerDispatcher;
...
public class WechatController {
    ...
    public String doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            //将不同类型的消息发送给不同的消息处理器
            AbstractMessageHandler messageHandler = messageHandlerDispatcher.doDispatch(msgType,eventType);
            //调用消息处理器处理消息
